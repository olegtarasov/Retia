...
//        public static void Clamp(this Matrix matrix, df min, df max)
//        {
...
//            var dst = new df[src.Length * count];
...
//        /// </summary>
//        public static void Accumulate(this Matrix C, Matrix A, Matrix B, df beta = 0.0f, df alpha = 1.0f, Transpose transposeA = Transpose.DontTranspose, Transpose transposeB = Transpose.DontTranspose)
//        {
...
//        ///     this = alpha*A + this
//        /// </summary>
//        public static void Accumulate(this Matrix x, Matrix A, df alpha = 1.0f)
//        {
//            if (A.ColumnCount == 1)
//            {
//                SumVec(A, x, alpha);
...
//        public static void CopyToArray(this Matrix matrix, df[] dest, ref int idx)
//        {
...
//        public static void CopyFromArray(this Matrix matrix, df[] src, ref int idx)
//        {
//            var ma = matrix.AsColumnMajorArray();
...
//        ///     result=alpha*x + y;
//        /// </summary>
//        private static void SumVec(Matrix x, Matrix y, df alpha)
//        {
